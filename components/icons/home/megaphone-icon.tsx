...
export function MegaphoneIcon() {
  return (
    <Svg width={40} height={40} viewBox="0 0 40 40" fill="none">
      <G clipPath="url(#megaphone-clip)">
        <G filter="url(#megaphone-filter)">
          <Path
