...
export default function HeartIcon({ width = 24, height = 24, color = '#000', filled = false }: HeartIconProps) {
  return (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill={filled ? color : 'none'}>
      <Path
