...
export function Footer({
  ...
  return (
    <View
      ...
      className={cn('w-full bg-blue-05 p-5', className)}
    >
      {/* 아이콘 링크 */}
      <View className="flex-row gap-3">
        <TouchableOpacity onPress={() => WebBrowser.openBrowserAsync(GITHUB_URL)}>
        ...
        <TouchableOpacity onPress={() => WebBrowser.openBrowserAsync(INSTAGRAM_URL)}>
          <Svg width="28" height="28" viewBox="0 0 28 28" fill="none">
            <Path
      ...
      <View className="flex-row flex-wrap items-center gap-[5px] py-1">
        ...
        <TouchableOpacity onPress={() => WebBrowser.openBrowserAsync(LOCATION_PRIVACY_URL)}>
