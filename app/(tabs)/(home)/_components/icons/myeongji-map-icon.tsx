...
export function MyeongjiMapIcon() {
  return (
    <Svg width={56} height={56} viewBox="0 0 56 56" fill="none">
      <G clipPath="url(#myeongji-map-clip)">
        <G filter="url(#myeongji-map-filter)">
          <Path
